...
class Plugin:
    ...
    def process(self, query):
        ...
        if accuracy1 > 0.5 or accuracy2 > 0.5 or accuracy3 > 0.5:
            print("MCAS: Pass Accuracy Value of 50%")
            print(f"SkyNET has selected {tag1} with a confidence of {accuracy1}")
            print(f"Strik3r has selected {tag2} with a confidence of {accuracy2}")
            print(f"Steve has selected {tag3} with a confidence of {accuracy3}")
            ...
            if tag1 == tag2 == tag3:
                ...
                values = {"tag1": accuracy1, "tag2": accuracy2, "tag3": accuracy3}
            ...
            print(f"SkyNET has selected {tag1} with an confidence of {accuracy1}")
            print(f"Strik3r has selected {tag2} with an confidence of {accuracy2}")
            print(f"Steve has selected {tag3} with an confidence of {accuracy3}")
